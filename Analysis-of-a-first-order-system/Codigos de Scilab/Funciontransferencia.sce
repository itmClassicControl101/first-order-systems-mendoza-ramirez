...
B=((b-(c/a))/((%s)+a));   //Guardar en B la segunda fracción parcial
disp('Y(s) es:');   //Mostrar en pantalla "Y(s) es:"
Ys=[A B];   //Guardar en un vector A y B
disp(Ys);   //Mostrar en un vector Y(s)
t=0:0.01:20;   //t tomará valores del 0 al 20 cada 0.01 valores
yt=(c/a)+((b-(c/a))*exp(-a*t));   //Y(t) sera la salida en función del tiempo
